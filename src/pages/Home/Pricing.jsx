    ...
    return (
        <>
            <div className='mt-[50px] lg:mt-[70px] xl:mt-[120px] text-center capitalize'>
                <h1 className='text-4xl sm:text-[50px] sm:leading-[60px] lg:text-[64px] lg:leading-[80px] font-bold text-[#0068E5]'>Pricing</h1>
                <p className='text-base lg:text-[18px] lg:leading-[28px] font-medium text-[#020F20] tracking-[0.5px] mt-3 mb-[50px]'>Flexible, scalable plans tailored for efficient storage management at the right price</p>
            </div>
