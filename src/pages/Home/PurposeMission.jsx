        ...
        <div className='py-[50px] capitalize'>
            <div className='flex flex-wrap md:flex-nowrap justify-center items-center gap-8 lg:gap-[100px] xl:gap-[125px]'>
                <div className='max-w-[690px] w-full'>
                    <h1 className='text-3xl sm:text-[40px] sm:leading-[40px] lg:text-[52px] lg:leading-[52px] font-bold text-[#0068E5]'>Our Purpose</h1>
            ...
            <div className='flex flex-wrap md:flex-nowrap justify-center items-center gap-8 lg:gap-[100px] xl:gap-[125px] mt-[50px] lg:mt-[120px]'>
                <div className='hidden md:block max-w-[535px] w-full order-2 md:order-1'>
                    <img src={Mission} alt="" />
                </div>
                <div className='max-w-[690px] w-full order-1 md:order-2'>
                    <h1 className='text-3xl sm:text-[40px] sm:leading-[40px] lg:text-[52px] lg:leading-[52px] font-bold text-[#0068E5]'>Our Mission</h1>
