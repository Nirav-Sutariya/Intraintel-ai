    ...
    return (
        <div className='capitalize'>
            <div className='mt-[50px] lg:mt-[70px] xl:mt-[120px] text-center'>
                <h1 className='text-4xl sm:text-[50px] sm:leading-[60px] lg:text-[64px] lg:leading-[80px] font-bold text-[#0068E5]'>Get In Touch</h1>
                <p className='text-base lg:text-[18px] lg:leading-[28px] font-medium text-[#020F20] tracking-[0.5px] mt-3 mb-[50px]'>Connect with Us for Tailored AI Storage Solutions. We're here to help with any questions or support you need</p>
            </div>

            <div className='flex flex-wrap lg:flex-nowrap justify-between gap-5 rounded-xl shadow-[0px_7px_29px_0px_#64646F33] p-5 mb-[70px] lg:mb-[100px] xl:mb-[120px]'>
